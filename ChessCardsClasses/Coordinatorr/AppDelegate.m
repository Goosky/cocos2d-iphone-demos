...
-(void) directorDidReshapeProjection:(CCDirector*)director
{
	if(director.runningScene == nil) {
        ...
        CCScene *scene = [CCBReader sceneWithNodeGraphFromFile:@"chesscarda.ccbi"];
...
@synthesize chessCardRound = _chessCardRound;
@synthesize chessCardScore = _chessCardScore;
...
-(void) loadResouces{
    ...
    [[CCSpriteFrameCache sharedSpriteFrameCache] addSpriteFramesWithFile:@"a_cards.plist"];
}
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"disney.sqlite"];
    NSError *error = nil;
